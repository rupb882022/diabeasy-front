...
{p&&p.profileimage? 
<Image source={{uri:p.profileimage.includes("http")?p.profileimage:ImageUri+p.profileimage}} style={p.select?styles.imageWhite('#FFCF84',5):styles.imageWhite('white',2)}/> :
